      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-600 text-base sm:text-lg">
            Klik menu di bawah ini untuk melihat bagaimana LaundrSaaS mempercepat pekerjaan harian kasir dan membantu owner menganalisis performa bisnis.
          </p>
        </div>
              ...
              <div className="bg-[#e5ddd5] rounded-2xl p-4 shadow-sm border border-slate-200/80 relative overflow-hidden font-sans text-xs">
                ...
                <div className="space-y-3 pt-3">
                  <div className="bg-white p-2.5 rounded-lg max-w-[85%] shadow-sm relative text-[10px] text-slate-800 animate-fade-in-up">
                    ...
                    <p className="mt-1 text-slate-500">Detail Nota: <span className="text-blue-600 underline">laundrsaas.com/nota/89</span></p>
